...
const Task = function(a, b, c, d) {
  ...
  if (typeof a === "undefined") {
    ...
    if (typeof a === "string") {
      ...
      if (typeof a.isComplete !== "undefined")
        internal.isComplete = a.isComplete;

      if (typeof a.estimates !== "undefined") {
        internal.best = a.estimates[0];
        internal.nominal = a.estimates[1];
        internal.worst = a.estimates[2];
      }

      if (typeof a.subtasks !== "undefined")
